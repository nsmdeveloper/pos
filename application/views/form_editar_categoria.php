...
<div id="content">
	...
	<div id="page-title" class="clearfix">
			...
			<ul class="breadcrumb">
			   <li class="active">Inventario - Editar Categoria</li>
			</ul>
			...
			<div class="span8">
				...
				<div class="widget">
					...
					?>	
						...
						<form action="<?php echo base_url(); ?>index.php/inventario/processEditarCategoria" method="post" id="inventario-form" class="form-horizontal" novalidate="novalidate">
							<fieldset>
