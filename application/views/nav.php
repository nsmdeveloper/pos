		...
		<div class="nav-collapse">
			...
			<ul class="nav">
				...
				<li class="nav-icon active">
					<a href="<?php echo base_url(); ?>index.php/facturacion/">
						<i class="icon-home"></i>
						<span>Home</span>
					</a>	    				
				</li>
				...
				<li class="nav-icon active">					
					<a href="<?php echo base_url()?>index.php/inventario/agregarArticulo">
						<i class="icon-th"></i>
				...
				<li class="nav-icon active">					
					<a href="<?php echo base_url()?>index.php/inventario/categoria">
						<i class="icon-th"></i>
				...
				<li class="nav-icon active">					
					<a href="<?php echo base_url()?>index.php/negocio">
						<i class="icon-th"></i>
				...
				<li class="nav-icon active">					
					<a href="<?php echo base_url()?>index.php/facturacion/ncf">
