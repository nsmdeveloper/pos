...
<div id="content" onclick="autohide()">
	...
	<div id="page-title" class="clearfix">
		...
		<div class="widget">
					...
					<div class="widget-content">
						...
						<div class="accordion" id="sample-accordion1">
				             <div class="accordion-group">
				              <div class="accordion-heading">
				                <a class="accordion-toggle" data-toggle="collapse" data-parent="#sample-accordion1" href="#collapseTwo1">
				                  <?php echo "Categorias de Productos en Inventario"?>
							 <br />	
				                </a>
				              ...
				              <div id="collapseTwo1" class="accordion-body collapse">
				                ...
				                <a onclick="categoria(this.id);" id="<?php echo $c; ?>" class="btn btn-primary show-categories" style="width: 150px;height:50px;margin:5px;;margin: 5px; padding-top: 20px;"><?php echo $c; ?></a>
							

						         <?php }?>
						         </div>	

						         <div id="display-categorias" style="display:none;">
						         <a class="btn btn-inverse btn-large" id="hide-productos"><<< Regresar A las Categorias</a>&nbsp;&nbsp;&nbsp;<h3 style="text-align: center;" id="category-name"></h3>

						         <img src="<?php echo base_url(); ?>third_party/template/img/loading.gif" id="loadingImage" style="display: none;text-align: center;" width="500" height="300" />
						         
						         <div id="show-productos">
						       <br />
						         </div>
						         <div id="nombre-categoria"></div>
						         </div>
...
<div  >
<img src="<?php echo base_url(); ?>third_party/template/img/loading.gif" id="loadingImage1" style="display: none;text-align: center;margin-bottom: 10px;" width="400" height="200" />
<img src="<?php echo base_url(); ?>third_party/template/img/loading.gif" id="loadingImage2" style="display: none;text-align: center;margin-bottom: 10px;" width="400" height="200" />

<div class="input_container">

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: #666;font-size: 14px;">Buscar Articulos:</span> <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="search" onclick="autohide()"  onblur="" ="autohide()" onkeyup="autocomplet()" autocomplete="off"  placeholder="Digite Articulo ha agregar..." />&nbsp;<button class="btn btn-primary add_field_button" onclick="return false;">Agregar Articulo +</button>
&nbsp;&nbsp;&nbsp;
<button class="accordion-toggle btn btn-primary" data-toggle="collapse" data-parent="#sample-accordion1" href="#collapseTwo1" onclick="return false;"> Mostrar / Ocultar Categorias</button>
...
function categoria(c){
	...
	$("#display-categorias").show();
	$(".show-categories").hide();
	//$("#nombre-categoria").html(nombre);


	/*
	$.post("<?php echo base_url(); ?>backend/add_product.php",
				{
					"categoria":categoria
				...
				function(data){
					...
					$("#nombre-categoria").html(data);

				
			});
	*/

	var url = "<?php echo base_url(); ?>backend/add_product.php";
	var data = {
					"categoria":categoria
...
function addProduct(codigo){
		...
		var url = "<?php echo base_url(); ?>backend/facturacion.php";
		var data = {
					"codigo":codigo,
					"number": x
...
$("#hide-productos").click(function(){

	$("#display-categorias").hide();
