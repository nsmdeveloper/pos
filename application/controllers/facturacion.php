...
class Facturacion extends CI_Controller {
	...
	public function guardarFacturacion(){
		...
		$nombre  = $this->input->post("productName");
		...
		$this->facturacion_model->guardarFacturacion($cliente, $documento, $ncf, $tipo, $codigo, $nombre, $qty , $precio, $itbis , $orden);
	...
	public function test(){
		...
		var_dump($this->facturacion_model->getCategoriasProductos());
